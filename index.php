        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">The Harvest</h1>
              <p class="text-white">
                ...
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em><b  id="quote"> “Farmers: the stewards of the earth, cultivating the seeds of today for the harvest of tomorrow.”</b ></em>
                    </h6>
                    <br />

                    <footer class="blockquote-footer vg text-dark"  >
                    
                    <em><b  id="quote">The earth is their canvas, the soil their artistry, and every crop a masterpiece of their dedication.</b ></em>
...
const apiKey = "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";   // Enter your apikey here
