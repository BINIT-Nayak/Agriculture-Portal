...
<input hidden name="tradeid" id="tradeid"  value="">
						...
						<td>   
						  <div class="form-group">     
							<input id="quantity" type="number" placeholder="Available Quantity" name="quantity" required class="form-control text-dark">   
						  </div> 
						</td>
...
?>
			...
			<?php
						...
						<!-- <a class="btn btn-info form-control" href="Payment.php">Pay</a>	 -->
						<a class="btn btn-info form-control" href="cregisterationform.php">Pay</a>					
