...
if($district_weather_id<=0){
    $district_weather_id=831004;
	// Mangalore - 1263780   , Mysore - 1262321 , Udupi - 1253952 , punjab- 1259223, delhi- 1273294
}
...
$apiKey = "0ee2fd0713751872d936dd2928ee0244"; //Your API KEY 
...
$googleApiUrl ="https://api.openweathermap.org/data/2.5/forecast?zip=" . $cityId . ",in&appid=" . $apiKey;
$ch = curl_init();
...
<div class="container ">
        ...
        <!-- form for entry of weather location -->
        <div>
        <form role="form" action="#" method="post" >  
				  <div class="card-header">
            <span class=" text-info" > Select Place of your choice  </span>	
						<span class="pull-right">
							<button type="submit" value="City_Code" name="City_Code" class="btn btn-warning btn-submit">SUBMIT</button>
						</span>		
          ...
          <div class="form-group">
											<input type = 'number' name = 'citycode' placeholder="PinCode of Place" required class="form-control">
...
<!-- <script>window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 9,zipid: '<?php echo $cityId ?>',appid: '0ee2fd0713751872d936dd2928ee0244',units: 'metric',containerid: 'openweathermap-widget-9',  });  (function() {var script = document.createElement('script');script.async = true;script.charset = "utf-8";script.src = "//openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();</script> -->

<!-- <script>window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 9,cityid: <?php echo $cityId ?>,appid: '0ee2fd0713751872d936dd2928ee0244',units: 'metric',containerid: 'openweathermap-widget-9',  });  (function() {var script = document.createElement('script');script.async = true;script.charset = "utf-8";script.src = "//openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();</script> --> 
