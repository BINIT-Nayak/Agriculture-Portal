...
if(t_params>60 or t_params<3) or (ph_params>9 or ph_params<4) or (r_params<20 or r_params >500) or (n_params<0 or n_params>150) or (p_params<0 or p_params>150) or (k_params<0 or k_params>210) or (h_params<10 or h_params>99):
    print("Crop cannot be grown in this conditions")
else:
    #Read the dataset
