...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    // fe4c81786b114f4cadcbcb1da86ed9a4
    // e13c1810209a4e6ca7997d39b797152c
    const endpoint = "https://newsapi.org/v2/everything?q=agriculture&sortBy=popularity&apiKey=fe4c81786b114f4cadcbcb1da86ed9a4";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
        ...
        $url="https://newsapi.org/v2/everything?q=agriculture&sortBy=popularity&apiKey=fe4c81786b114f4cadcbcb1da86ed9a4";   //Your API KEY
