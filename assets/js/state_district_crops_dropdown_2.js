...
const cropOptions = {
  PURULIA:{
    Autumn     :['Ragi','Rice','Dry chillies','Sesamum','Maize','Groundnut','Jowar','Small millets'],
    Kharif     :['Horse-gram','Mesta','Moong(Green Gram)','Other Kharif pulses','Soyabean','Urad','Arhar/Tur','Dry ginger','Jowar','Maize','Niger seed','Ragi',' Small millets','Groundnut','Bajra','Sunflower','Cotton(lint)',
    ,'Garlic','Jute','Sannhamp','Moth'],
    Rabi       :['Gram','Khesari','Masoor','Moong(Green Gram)','Oilseeds total','Urad','Wheat','Horse-gram','Linseed','Peas & beans (Pulses)', 'Rapeseed &Mustard','Dry chillies','Sannhamp','Groundnut','Arhar/Tur',
    'Safflower','Moth','Ragi',],
    Summer:['Moong(Green Gram)','Rice','Sesamum','Groundnut','Maize',],
    WholeYear :['Arhar/Tur','Coconut','Dry chillies','Groundnut','Jowar','Linseed','Maize','Niger seed','Potato','Pulses',' Rapeseed &Mustard', 'Sannhamp','Sesamum','Small millets','Sugarcane','Turmeric','Arecanut','Tobacco',],
    Winter:['Rice','Potato','Sesamum',],
  },
  ZUNHEBOTO:{
Kharif:['Bajra',
  'Jowar',
  ...
  JALPAIGURI: {
    Autumn     : ['Ragi', 'Rice', 'Dry chillies', 'Sesamum', 'Maize', 'Groundnut'],
    Kharif     : ['Horse-gram', 'Jute', 'Mesta', 'Moong(Green Gram)', 'Urad', 'Dry ginger', 'Maize', 'Niger seed', 'Ragi', 'Arhar/Tur', 'Small millets', 'Khesari', 'Sunflower', 'Garlic'],
    Rabi       : ['Khesari', 'Masoor', 'Moong(Green Gram)', 'Oilseeds total', 'Urad', 'Wheat', 'Barley', 'Gram', 'Horse-gram', 'Linseed', 'Peas & beans (Pulses)', 'Rapeseed &Mustard', 'Small millets', 'Dry chillies', 'Groundnut', 'Arhar/Tur', 'Safflower', 'Maize', 'Potato', 'Ragi'],
    Summer     : ['Rice', 'Groundnut', 'Moong(Green Gram)', 'Sesamum', 'Maize'],
    WholeYear : ['Arecanut', 'Arhar/Tur', 'Barley', 'Coconut ', 'Dry chillies', 'Groundnut', 'Linseed', 'Maize', 'Niger seed', 'Potato', 'Pulses total', 'Rapeseed &Mustard', 'Sesamum', 'Small millets', 'Sugarcane', 'Turmeric', 'Tobacco'],
    Winter     : ['Rice', 'Potato', 'Sesamum'],
},
